...
local mappings = {
  n = {
    ...
    ["<leader>rr"] = { function () vim.cmd.RustLsp('runnables', )  end, desc= ""},
    ["<leader>re"] = { function () vim.cmd.RustLsp('expandMacro', )  end, desc= ""},
    ["<leader>ru"] = { function () vim.cmd.RustLsp('moveItem', 'up')  end, desc= ""},
    ["<leader>rd"] = { function () vim.cmd.RustLsp('moveItem', 'down')  end, desc= ""},
    ["<leader>r"] = { function () vim.cmd.RustLsp('hover', 'action' )  end, desc= ""},
    ["<leader>r"] = { function () vim.cmd.RustLsp('hover', 'range' )  end, desc= ""},
    ["<leader>r"] = { function () vim.cmd.RustLsp('explainError', )  end, desc= ""},
    ["<leader>r"] = { function () vim.cmd.RustLsp('renderDiagnostic', )  end, desc= ""},
    ["<leader>r"] = { function () vim.cmd.RustLsp('openCargo', )  end, desc= ""},
    ["<leader>r"] = { function () vim.cmd.RustLsp('parentModule', )  end, desc= ""},
    ["<leader>r"] = { function () vim.cmd.RustLsp('joinLines', )  end, desc= ""},
    ["<leader>r"] = { function () vim.cmd.RustLsp('ssr','query' )  end, desc= ""},
    ["<leader>r"] = { function () vim.cmd.RustLsp('crateGraph', 'backend')  end, desc= ""},
    ["<leader>r"] = { function () vim.cmd.RustLsp('syntaxTree', )  end, desc= ""},
    ["<leader>r"] = { function () vim.cmd.RustLsp('view', 'mir')  end, desc= ""},
    ["<leader>r"] = { function () vim.cmd.RustLsp('view', 'hir')  end, desc= ""},
    ["<leader>r"] = { function () vim.cmd.RustLsp('flyCheck', )  end, desc= ""},
    ["<leader>r"] = { function () vim.cmd.RustLsp('logFile', )  end, desc= ""},
